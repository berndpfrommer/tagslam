...
namespace tagslam {
  ...
  public:
    ...
    void callback2(const ImageConstPtr &,
                   const ImageConstPtr &);
    void callback3(const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &);
    void callback4(const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &);
    void callback5(const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &);
    void callback6(const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &);
    void callback7(const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &);
    void callback8(const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   ...
                   const ImageConstPtr &,
                   const ImageConstPtr &);
    void callback9(const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
                   const ImageConstPtr &,
  ...
  private:
    ...
    Image, Image> ApproxPolicy2;
    typedef message_filters::sync_policies::ApproximateTime<
      Image, Image, Image> ApproxPolicy3;
    typedef message_filters::sync_policies::ApproximateTime<
      Image, Image, Image, Image> ApproxPolicy4;
    typedef message_filters::sync_policies::ApproximateTime<
      Image, Image, Image, Image, Image> ApproxPolicy5;
    typedef message_filters::sync_policies::ApproximateTime<
      Image, Image, Image, Image, Image, Image> ApproxPolicy6;
    typedef message_filters::sync_policies::ApproximateTime<
      Image, Image, Image, Image, Image, Image, Image> ApproxPolicy7;
    typedef message_filters::sync_policies::ApproximateTime<
      Image, Image, Image, Image, Image, Image, Image, Image> ApproxPolicy8;
    typedef message_filters::sync_policies::ApproximateTime<
      Image, Image, Image, Image, Image, Image, Image, Image, Image> ApproxPolicy9;
